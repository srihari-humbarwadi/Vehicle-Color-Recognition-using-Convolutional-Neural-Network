...
from tensorflow.python.keras.layers import concatenate, Conv2D, MaxPooling2D, Dense, Input, Activation, BatchNormalization, Dropout, GlobalAveragePooling2D, Lambda, Flatten
...
def ColorModel(img_height=227, img_width=227):
    ...
    image_output = Dense(4096, activation='softmax', kernel_initializer='he_normal', name='fc1')(image_output)
    image_output = Dense(4096, activation='softmax', kernel_initializer='he_normal', name='fc2')(image_output)
    image_output = Dense(4096, activation='softmax', kernel_initializer='he_normal', name='fc3')(image_output)
    image_output = Dense(20, activation='softmax', kernel_initializer='he_normal', name='color_output')(image_output)
    print('Successful')
